...
namespace caffe {
    ...
    */
    ...
    void RPNLayer<Dtype>::Forward_cpu(
        ...
        //get sores toward right，number of anchors_nums_  score to bg before, after anchors_nums_ is the socre of fg , we need the fg
        ...
        //gen local anchors toward right
        ...
        //clock_t start, end;
        //start = clock();
        std::sort(aboxes.rbegin(), aboxes.rend()); // Descending
        if (pre_nms_topN_ > 0)
        {
